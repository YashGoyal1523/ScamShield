        ...
        <form onSubmit={onSubmitHandler} className="flex flex-col gap-4">
          ...
          <div className="relative">
            <input
              ...
              required
              minLength={6}
              className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 pr-11 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-blue-500 transition-colors"
            />
            <button
              type="button"
